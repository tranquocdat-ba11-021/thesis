...
if (isset($_SESSION['role']) && $_SESSION['role'] == 2) {
    header('Location: restricted.php'); // Chuyển hướng đến trang truy cập hạn chế nếu người dùng không có quyền truy cập
    exit();
}
...
<body>
    <div class="wrapper">
        ...
        <div id="content2">
            <div class="container">
                <h2 class="header-title text-center">Lịch Làm Việc Của Các Bác Sĩ</h2>
                <!-- Bộ Lọc -->
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                <div>
                    ...
                    <button class="btn btn-danger" id="delete-event" data-id="${info.event.id}">Delete Event</button>
                </div>
            `;
