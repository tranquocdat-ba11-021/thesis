    ...
    <div class="wrapper">
        ...
        <div id="content2">
            ...
            $sql = "SELECT a.id, u.full_name, u.email, u.phone, p.pet_name, s.name_service, a.appointment_date, a.appointment_start_time, a.appointment_end_time, a.appointment_time, a.additional_info, s.price, a.status,
                       pay.payment_method, pay.payment_status, pay.amount, d.name_doctor, s.type AS service_type
                FROM appointments a
            ...
            $stmt->execute();
            $stmt->bind_result($id, $full_name, $email, $phone, $pet_name, $name_service, $appointment_date, $appointment_start_time, $appointment_end_time, $appointment_time, $additional_info, $price, $status, $payment_method, $payment_status, $amount, $name_doctor, $service_type);
            $stmt->fetch();
            $stmt->close();
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" id="status" class="form-control">
                                <option value="waiting" <?php echo $status === 'pending' ? 'selected' : ''; ?>>Waiting</option>
